    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'ADMINISTRADOR'), (2, 'SUBSCRIPTION'), (3, 'PROFESOR'), (4, 'ALUMNO')], default=2)),
        ...
        migrations.AddField(
            ...
            name='subscriptions',
            field=models.ManyToManyField(through='users.AccountSubscriptions', to='plans.Plan'),
        ),
        migrations.AddField(
            model_name='useraccount',
